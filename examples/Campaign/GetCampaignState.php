...
try {
    $response = $client->campaignClient()->getCampaignState($customerId, $campaignId);
    printf('Campaign "%s" has state "%s" %s', $response->campaignId->toString(), $response->state->value, PHP_EOL);
